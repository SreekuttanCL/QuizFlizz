...
namespace QuizApp.Model
{
    public class QuestionBank : Question
    {
      ...
      public  List<Question> SportsQuestion = new List<Question>()
      {
            new Question { QuestionText = "'The Hurts Locker' won the Academy Award for Best picture in 2009", CorrectAnswer = true},
        ...
        public List<Question> MoviesQuestion = new List<Question>()
        {
            new Question { QuestionText = "'we failed in xamarin class", CorrectAnswer = true},
            new Question { QuestionText = "Gone with the wind was the first movie to win the Oscar for Best picture", CorrectAnswer = false},
            new Question { QuestionText = "LA filmed in Vancouver", CorrectAnswer = false},
            new Question { QuestionText = "Batman made his first movie apperance in the 1940s", CorrectAnswer = false},
            new Question { QuestionText = "Tom Hanks speaks less than 200 words in Toy Story 2 ", CorrectAnswer = false},
        ...
        public List<Question> PoliticsQuestion = new List<Question>()
        {
            new Question { QuestionText = "we will pass in xamarin class", CorrectAnswer = true},
            new Question { QuestionText = "Gone with the wind was the first movie to win the Oscar for Best picture 1900", CorrectAnswer = false},
            new Question { QuestionText = "LA filmed in Vancouver", CorrectAnswer = false},
            new Question { QuestionText = "Batman made his first movie apperance in the 1940s", CorrectAnswer = false},
            new Question { QuestionText = "Tom Hanks speaks less than 200 words in Toy Story 2 ", CorrectAnswer = false},
            new Question { QuestionText = "Paul Newman starred in the 1961 movie The Hustler", CorrectAnswer = true},
